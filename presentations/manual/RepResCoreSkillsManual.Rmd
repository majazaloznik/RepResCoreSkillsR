...
If you are having issues with the `.xlsx` package on your current computer, you can catch up with the rest of the practical by downloading these three tables from the repository instead.  
