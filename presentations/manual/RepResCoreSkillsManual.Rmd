...
title: |
 | Data analysis:
 | *Core skills for reproducible data analysis in R*
subtitle: |
...
# PRACTICAL 1: Priject management and Data Tidying {-}
...
data.zip.url <- "http://spss.allenandunwin.com.s3-website-ap-southeast-2.amazonaws.com/Files/survey.zip"
...
Don't forget, we have two more tables, one for each perception question. Think about how (if?) you could merge all three tables into one tidy table! One option is to add a new variable that tells us what the perception is referring to:
