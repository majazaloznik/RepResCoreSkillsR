...
3. You can also download the manual and slides to your `presentation` folder, and the two reference files from teh `literature` folder. 
...
[Use `install.packages("name of package")` if the packages are not yet installed on your system. ]
